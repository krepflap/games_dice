...
Gem::Specification.new do |gem|
  ...
  # However, it has a C extension, and v3.0.0 does not compile for 1.8.7. This only affects the gem build process, and
  # is only really used in environments like Travis. It is safe to wrap like this in the gemspec.
